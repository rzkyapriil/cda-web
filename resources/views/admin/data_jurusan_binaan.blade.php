...
<div class="rounded-lg dark:border-gray-700 mt-16 ">
    ...
    <div class="flex justify-between w-full mb-4">
        <div class="flex max-w-[300px] sm:max-w-full">
            <h1 class="flex self-center text-2xl sm:text-3xl font-extrabold dark:text-white">Data Jurusan</h1>
        </div>
        <!-- Button with Modal -->
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form class="space-y-6" method="POST" action="{{route('admin.create-jurusan-binaan')}}">
                            ...
                            <div>
                                ...
                                <input type="text" id="nama_jurusan_binaan" name="nama_jurusan_binaan"

...
<div class="rounded-lg dark:border-gray-700">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-2.5 w-full mb-4">
        ...
        <div class="flex justify-center lg:justify-end items-center gap-1.5 w-full">
            <form method="get" action="{{ route('jurusan-binaan.search') }}" class="flex w-full lg:w-auto">
                <input type="text" id="cari" name="cari" placeholder="cari nama jurusan binaan" class="bg-gray-50 border border-black text-gray-900 text-xs rounded-s-lg focus:ring-blue-500 focus:border-blue-500 block w-full lg:w-60 h-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div class="relative w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 border border-black">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form class="space-y-6" method="POST" action="{{ route('jurusan-binaan.store') }}">
                        @csrf
                        <div>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-2.5 py-2 text-right flex justify-end">
                        <form method="POST" action="{{ route('jurusan-binaan.edit', $data->id) }}">
                            @csrf
                            <button type="submit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline mr-4 bg-none">
                                Edit
                            </button>
                        </form>
                        <form method="POST" action="{{ route('jurusan-binaan.destroy', $data->id) }}">
                            @csrf
                            @method('DELETE')

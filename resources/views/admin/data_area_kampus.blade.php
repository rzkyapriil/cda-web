...
<div class="rounded-lg dark:border-gray-700 mt-16 ">
    ...
    <div class="flex justify-between w-full mb-4">
        <div class="flex max-w-[300px] sm:max-w-full">
            <h1 class="flex self-center text-2xl sm:text-3xl font-extrabold dark:text-white">Data Area Kampus</h1>
        </div>
        <!-- Button with Modal -->
            ...
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Tambahkan Area Kampus</h3>
                        <form class="space-y-6" method="POST" action="{{route('admin.create-area-kampus')}}">
                            ...
                            <div>
                                <label for="nama_daerah"
                                    ...
                                    Area Kampus</label>
                                <input type="text" id="nama_area_kampus" name="nama_area_kampus"

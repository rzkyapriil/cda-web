...
<div class="rounded-lg dark:border-gray-700 mt-16 ">
    ...
    <div class="flex justify-between w-full mb-4">
        <div class="flex max-w-[300px] sm:max-w-full">
            <h1 class="flex self-center text-2xl sm:text-3xl font-extrabold dark:text-white">Data Dosen</h1>
        </div>
        <!-- Button with Modal -->
            ...
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Tambahkan Nama Dosen</h3>
                        <form class="space-y-6" method="POST" action="{{route('admin.create-dosen')}}">
                            @csrf
                            <div>
                                <label for="binaan_id"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Binaan</label>
                                <select type="text" id="binaan_id" name="binaan_id"
                                    ...
                                    <option value="{{$data->id}}">{{$data->nama_fakultas . ' - ' .
                                        $data->nama_jurusan_binaan . ' - ' . $data->program_binaan}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                                <label for="nama_dosen"
                                    ...
                                    Dosen</label>
                                <input type="text" id="nama_dosen" name="nama_dosen" placeholder="nama"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    required>
                            </div>
                            <div>
                                <label for="kode_dosen"
                                    ...
                                    Dosen</label>
                                <input type="text" id="kode_dosen" name="kode_dosen" placeholder="kode"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    required>
                            </div>

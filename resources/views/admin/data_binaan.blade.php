...
<div class="rounded-lg dark:border-gray-700 mt-16 ">
    ...
    <div class="flex justify-between w-full mb-4">
        <div class="flex max-w-[300px] sm:max-w-full">
            <h1 class="flex self-center text-2xl sm:text-3xl font-extrabold dark:text-white">Data Binaan</h1>
        </div>
        <!-- Button with Modal -->
            ...
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Tambahkan Jurusan Binaan</h3>
                        <form class="space-y-6" method="POST" action="{{route('admin.create-binaan')}}">
                            ...
                            <div>
                                ...
                                <select type="text" id="fakultas_id" name="fakultas_id"
                            ...
                            <div>
                                <label for="jurusan_binaan_id"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jurusan Binaan</label>
                            ...
                            <div>
                                <label for="program_binaan"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Program
                                    Jurusan Binaan</label>
                                <input type="text" id="program_binaan" name="program_binaan"
                                    placeholder="jurusan binaan"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    required>
                            </div>
                            <div>
                                <label for="area_kampus_id"
                                       class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Area kampus</label>
                                <select type="text" id="area_kampus_id" name="area_kampus_id"

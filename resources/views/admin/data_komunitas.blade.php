...
<div class="rounded-lg dark:border-gray-700 mt-16 ">
    ...
    <div class="flex justify-between w-full mb-4">
        <div class="flex max-w-[300px] sm:max-w-full">
            <h1 class="flex self-center text-2xl sm:text-3xl font-extrabold dark:text-white">Data Komunitas</h1>
        </div>
        <!-- Button with Modal -->
            ...
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Tambahkan Data Komunitas</h3>
                        <form class="space-y-6" method="POST" action="{{route('admin.create-komunitas')}}">
                            @csrf
                            <div>
                                <label for="komunitas_id"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ID Komunitas
                                </label>
                                <input type="text" id="komunitas_id" name="komunitas_id" placeholder="komunitas"
                            ...
                            <div>
                                <label for="mitra"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mitra
                                </label>
                                <input type="text" id="mitra" name="mitra" placeholder="mitra"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    required>
                            </div>
                            ...
                            <div>
                                <label for="nama_pic"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">nama PIC
                                    komunitas
                                </label>
                                <input type="text" id="nama_pic" name="nama_pic" placeholder="nama"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    required>
                            </div>
                            ...
                            <div>
                                <label for="no_tlp"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">No. Tlp
                                </label>
                                <input type="text" id="no_tlp" name="no_tlp" placeholder="no.Tlp"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    required>
                            </div>
                            ...
                            <div>
                                <label for="jenis_usaha"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis Usaha
                                </label>
                                <input type="text" id="jenis_usaha" name="jenis_usaha" placeholder="jenis_usaha"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    required>
                            </div>

<footer class="flex w-full bg-white border-t border-[#008ED3]">
  <div class="flex flex-col md:flex-row gap-4 p-6 md:gap-0 justify-between items-center w-full max-w-screen-xl mx-auto">
    ...
    <div class="flex items-center justify-center gap-4">
      <a href="https://www.instagram.com/cebinus/" title="cebinus" target="_blank">
      ...
      <a href="https://www.youtube.com/@cebinusuniversity" title="Community Empowerment BINUS" target="_blank">
        <svg class="w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 180">

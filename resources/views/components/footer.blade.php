<footer class="flex w-full bg-white py-5 border-t border-[#008ED3]">
  <div class="flex justify-between items-center w-full max-w-screen-xl mx-auto">
    ...
    <div class="flex justify-center gap-4">
      <a href="https://www.instagram.com/cebinus/" title="cebinus" target="_blank">
        <svg class="h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
      ...
      <a href="https://www.youtube.com/@cebinusuniversity" title="Community Empowerment BINUS" target="_blank">
        <svg class="h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 180">

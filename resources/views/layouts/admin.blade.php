...
<aside id="sidebar-multi-level-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
        <a href="{{route('admin.dashboard')}}" class="flex flex-col mb-5 items-center">
            <img src="{{asset('images/logo-cda.png')}}" class="h-24" alt="Flowbite Logo">
        </a>
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{route('admin.dashboard')}}"
                    class="flex items-center p-2 text-gray-900 border border-black rounded-lg hover:bg-gray-300 group">
            ...
            <li>
                <button type="button"
                    class="border border-black flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-300"
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{route('admin.dosen')}}"
                            class="border border-[#008ED3] flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Data
                            Dosen</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{route('admin.jurusan-binaan')}}"
                            class="border border-[#008ED3] flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Data
                            Jurusan</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{route('admin.area-kampus')}}"
                            class="border border-[#008ED3] flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Data
                            Area Kampus</a>
                    </li>
                    <li>
            ...
            <li>
                <a href="#"
                    class="border border-black hover:bg-gray-300 flex items-center p-2 text-gray-900 rounded-lg group">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                        <path
            ...
            <li>
                <form method="post" action="{{route('users.logout')}}" class="w-full">
                    @csrf
                    <button type="submit"
                        class="flex items-center p-2 text-gray-900 border border-black rounded-lg hover:bg-gray-300 group w-full">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                            <path
